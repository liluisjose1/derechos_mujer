        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2018 <a href="https://www.facebook.com/profile.php?id=100003084681213" class="font-weight-bold ml-1" target="_blank">Luis Iraheta</a>
            </div>
          </div>
          <div class="col-xl-6">
  ...
  <!-- Argon JS -->
  <script src="<?= base_url()?>public/assets/js/argon.js?v=1.0.0"></script>
